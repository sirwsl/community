		                ...
		                <div class="ibox-content">
		                    <div class="row m-b-sm m-t-sm">
								...
								<div class="col-md-4" style="float: right;">
									<div class="input-group" >
										<input type="text" placeholder="请输入社团名称或学生姓名" class="input-sm form-control"> <span class="input-group-btn">
		                    ...
		                    <div class="project-list row">
		                        <table class="table table-hover">
		                            ...
		                            <tbody>
		                                <tr>
		                                    <td class="project-title"><a>201713453312</a></td>
											<td class="project-title"><a>徐震宇</a></td>
											<td class="project-title"><a>计算机协会</a></td>
											...
											<td>
											    <a class="btn btn-primary btn-sm" href="addStudent.jsp"><i class="fa fa-pencil"></i>修改</a>
